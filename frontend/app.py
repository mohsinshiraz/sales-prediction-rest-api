# =============================================================================
# SuperKart Sales Forecaster - Streamlit frontend
#
# A thin user interface over the Flask backend. It holds NO model and no
# scikit-learn dependency - it only collects user input and calls the REST API.
# That decoupling means a model retrain never requires a frontend rebuild.
#
# Two modes:
#   1. Online prediction - a form for a single product/store combination
#   2. Batch prediction  - upload a CSV and score every row
# =============================================================================

# streamlit = the UI framework, pandas = tabular handling of input and results,
# requests = the HTTP client used to call the backend
...
Store_Age_Years = st.number_input("Store age year", min_value=0, max_value=150, help="Enter the age of the stores.")
